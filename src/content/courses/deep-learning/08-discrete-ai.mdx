...
![image.png](/images/deep-learning/08-discrete-ai/image.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%201.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%202.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%203.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%204.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%205.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%206.png)
...
- During **backward pass**:
    ...
    Gradients stop at detach($z_q - z_e$), so only $z_e$ is considered and receives gradients.
...
![image.png](/images/deep-learning/08-discrete-ai/image%207.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%208.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%209.png)
...
![Screenshot 2025-12-04 165406.png](/images/deep-learning/08-discrete-ai/Screenshot_2025-12-04_165406.png)

![Screenshot 2025-12-04 165619.png](/images/deep-learning/08-discrete-ai/Screenshot_2025-12-04_165619.png)

![Screenshot 2025-12-04 165626.png](/images/deep-learning/08-discrete-ai/Screenshot_2025-12-04_165626.png)

![Screenshot 2025-12-04 165633.png](/images/deep-learning/08-discrete-ai/Screenshot_2025-12-04_165633.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%2010.png)
...
![Screenshot 2025-12-04 174359.png](/images/deep-learning/08-discrete-ai/Screenshot_2025-12-04_174359.png)
...
![image.png](/images/deep-learning/08-discrete-ai/image%2011.png)
...
| Concept | Description |
|---|---|
| **Discretization** | Mapping continuous representations to discrete symbols; aligns with how humans interpret language, images, music |
| **Non-differentiability problem** | Discrete operations (argmax, quantize) have zero gradients, blocking backpropagation |
| **VQ-VAE** | Autoencoder with discrete codebook: encoder $\to$ nearest-neighbor quantization $\to$ decoder; avoids posterior collapse |
| **Codebook** | Learnable lookup table $e \in \mathbb{R}^{K \times D}$; each entry represents a discrete latent concept |
| **Straight-Through Estimator** | Forward: use discrete output; backward: copy gradients as if identity. Implemented as $z_q^{st} = z_e + \text{detach}(z_q - z_e)$ |
| **VQ-VAE loss** | Reconstruction + VQ term (moves codebook toward encoder) + commitment term (moves encoder toward codebook) |
| **Autoregressive factorization** | $p(z) = \prod_t p(z_t \mid z_{<t})$; chain rule decomposes joint distribution into sequential conditionals |
| **PixelCNN** | 2D autoregressive model using masked convolutions; learns a prior over discrete latent codes |
| **Masked convolutions** | Type A (first layer): excludes current pixel; Type B (subsequent layers): includes current pixel features |
| **Teacher forcing** | Train with ground-truth inputs instead of model predictions; enables parallel training via single forward pass |
| **Gumbel-Softmax** | Differentiable sampling from categorical distributions: $y_k = \text{softmax}((\log \pi_k + g_k)/\lambda)$; temperature $\lambda$ controls discreteness |
| **VQ-VAE + PixelCNN pipeline** | Train VQ-VAE (learn codebook) $\to$ train PixelCNN on latent codes (learn prior) $\to$ sample + decode |
