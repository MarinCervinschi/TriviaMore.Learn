...
![image.png](/images/deep-learning/10-self-supervised-learning/image.png)
...
![**Left:** Drawing of a dollar bill from memory. **Right:** Drawing subsequently made with a dollar bill present](/images/deep-learning/10-self-supervised-learning/image%201.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%202.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%203.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%204.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%205.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%206.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/2151a238-599b-49b5-9cbd-329fd5f4744e.png)

![image.png](/images/deep-learning/10-self-supervised-learning/dd9d88bf-fcb9-4b0b-91c1-bbc30f197dbf.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%207.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%208.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%209.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2010.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2011.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2012.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2013.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2014.png)

![image.png](/images/deep-learning/10-self-supervised-learning/image%2015.png)

![image.png](/images/deep-learning/10-self-supervised-learning/image%2016.png)
...
- **Data Augmentation:** Pairing the original input with a distorted version of itself (e.g., through cropping, rotating, etc.).
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2017.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2018.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/21e24e3b-3481-4191-aaeb-a120610afe4e.png)

![image.png](/images/deep-learning/10-self-supervised-learning/image%2019.png)

**The pipeline**

Starting with a single image $x$, the framework follows these steps:

1. **Data Augmentation**: Two different augmentation operators ($t$ and $t'$) are sampled from the same family $\mathcal{T}$ and are applied to produce two correlated views, $x_i$ and $x_j$, forming a **positive pair**.
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2020.png)
...
![image.png](/images/deep-learning/10-self-supervised-learning/image%2021.png)
...
These trade-offs motivate alternative contrastive methods (such as MoCo and BYOL) that decouple the number of negatives from the batch size, achieving comparable performance with significantly lower hardware requirements.
...
| Concept | Description |
|---|---|
| **Self-supervised learning (SSL)** | Generates supervision signals from the data itself; learns representations from unlabeled data for downstream tasks |
| **Pretext task** | Synthetic prediction problem (rotation, jigsaw, colorization) that forces the model to learn useful features without labels |
| **Two-stage pipeline** | Pretrain on unlabeled data with a pretext task, then fine-tune on a small labeled dataset for the target task |
| **Jigsaw puzzles** | Predict spatial arrangement of shuffled image patches; learns patch-level semantics and spatial relationships |
| **Colorization** | Predict colors from grayscale; forces the model to learn semantic recognition and object-color associations |
| **Self-prediction** | Mask or hide part of the input, predict it from the rest; includes masked generation and autoregressive generation |
| **Masked Auto-Encoder (MAE)** | Masks 80-90% of image patches; encoder processes only visible patches, decoder reconstructs masked ones |
| **Contrastive learning** | Pull positive pairs (augmented views of same input) together, push negative pairs apart in embedding space |
| **InfoNCE loss** | Cross-entropy over $N$-way softmax: identify the positive sample among $N-1$ negatives |
| **SimCLR** | Contrastive framework: augment $\to$ encode $\to$ project $\to$ InfoNCE loss; uses large batches as implicit negatives |
| **Projection head** | MLP $g(\cdot)$ maps representations to contrastive loss space; discarded after training to preserve richer features in $f(\cdot)$ |